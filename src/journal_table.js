// ================================
// Decision Journal Table Module
// ================================
// Rendering, CRUD, sorting, stats, and chart for the Decision Journal table.
//
// Globals consumed (set by renderer.js before this runs):
//   journalData, csvPath, tableBody, statYes, statNo, statRate,
//   addRowBtn, currentSort
//
// Globals produced:
//   loadData, saveData, renderTable, updateStats, renderChart,
//   sortData, updateHeaderUI, addRow, deleteRow,
...
// ─── Pure Stats / Chart Logic (testable) ──────────────────────────────
